...
def run_evaluation_and_visualization():
    ...
    _, valid_origin, test_origin, train_scaled, valid_scaled, test_scaled, _, _, _, _, _, y_minmax_scaler, y_standard_scaler = load_data(path)
    ...
    val_mae, val_rmse, val_mape, val_r2 = metrics(
        ...
        data_loader, y_standard_scaler, y_minmax_scaler, device
    )
